...
contract ExternalERC20 is IERC20 {
  ...
  */
   ...
   */
  function _transferFrom(address originSender, address from, address to, uint256 value)
    internal
  {
    require(value <= _externalERC20Storage.allowed(from, originSender));

    _externalERC20Storage.setAllowed(from, originSender,
    ...
    internal
  {
    ...
    _externalERC20Storage.setAllowed(originSender, spender,
                                     _externalERC20Storage.allowed(originSender, spender).add(addedValue));
    emit Approval(originSender, spender, _externalERC20Storage.allowed(originSender, spender));
  }
