# eTokenize - an [eToro](https://www.etoro.com/) stablecoin
[![Build Status](https://circleci.com/gh/eTokenize/eTokenize.svg?style=shield&circle-token=797dc9ae3f839ac4fc5d5edad6c993ae9faa3943&maxAge=0)](https://circleci.com/gh/eTokenize/eTokenize) [![Coverage Status](https://coveralls.io/repos/github/eTokenize/eTokenize/badge.svg?t=un8yQ7&maxAge=0)](https://coveralls.io/github/eTokenize/eTokenize)

eTokenize is stablecoin implementation by [eToro](https://www.etoro.com/) targeting the [Ethereum](https://www.ethereum.org/) platform.
...
### eTokenize - ERC20
This document describes the design and implementation of the smart contracts comprising eTokenize which is intended to be used for powering several different stablecoins representing various assets. At its core, eTokenize is an ERC20 token with additional supporting infrastructure relating to token management, permission management and token upgradability. The remainder of this document gives a high-level overview of the design and implementation of the token itself and its supporting infrastructure.
...
`contracts/token` | Contains the eTokenize implementation
