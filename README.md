...
are described separately in Figure 2.*
...
of the interfaces of the various components is shown in Figure 3. The
...
*__Figure 2:__ Rendering of the token upgrade process. On the left
